...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 RWRD = IBEP20(0xfAb5Bf28032FF9511067Ab11842A652a6368F5E1);
...
contract BabyQuint is IBEP20, Auth {
    using SafeMath for uint256;

    address WBNB = 0xae13d989daC2f0dEbFf460aC112a837C89BAa7cd;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEV = 0x62eA762d9f2672f82d26b94f56849881831B9eaB;

    string constant _name = "Baby Quint";
    string constant _symbol = "BabyQuint";
